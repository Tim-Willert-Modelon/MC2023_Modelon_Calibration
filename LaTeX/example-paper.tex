...
\title{Calibration Workflow for Mechanical and Thermal Applications}
\author[1]{Tim Willert}
\author[2]{Peter Sundström}
\affil[1]{Modelon K.K., Japan, {\small\texttt{tim.willert@modelon.com}}}
\affil[2]{Modelon AB, Sweden, {\small\texttt{peter.sundstrom@modelon.com}}}
...
\section{Motivation}
Brief outline why calibration is relevant in MBD
\section{Optimization}
Explanation of general optimization methods: Parameter sweep, derivative-free optimization, dynamic optimziation
\section{Derivative-free optimization}
Short Summary of algorithms (Nelder-mead, Cobyla etc.)
\section{Technical setup}
Cloud-based Impact+Dash
Used algorithms
\section{Applications}
\subsection{Mechanical}
Calibration setup workflow/results
\subsection{Thermal}
Calibration setup workflow/results
